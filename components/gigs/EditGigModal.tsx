// components/gigs/EditGigModal.tsx
'use client';

import { useState, useEffect } from 'react';
import { X } from 'lucide-react';
import { IGigWithId, CreateGigInput } from '@/types/gigs';

interface EditGigModalProps {
  isOpen: boolean;
  onClose: () => void;
  gig: IGigWithId;
  onUpdate: (updatedGig: IGigWithId) => void;
}
